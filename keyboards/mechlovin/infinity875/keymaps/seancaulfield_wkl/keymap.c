...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE_LINUX] = LAYOUT_all(
        ...
        KC_LCTL,   XXXXXXX, KC_LALT,                            KC_SPC,                             XXXXXXX, KC_RALT, XXXXXXX, KC_RGUI,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_BASE_MACOS] = LAYOUT_all(
        ...
        KC_LCTL,   XXXXXXX, KC_LCMD,                            KC_SPC,                             XXXXXXX, KC_RCMD, XXXXXXX, KC_ROPT,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
