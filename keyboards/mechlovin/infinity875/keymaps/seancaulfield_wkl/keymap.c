...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE_LINUX] = LAYOUT_all(
        ...
        KC_LSFT,   KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RGUI,                     KC_UP,
        KC_LCTL,   XXXXXXX, KC_LALT,                            KC_SPC,                             XXXXXXX, FNLINUX, XXXXXXX, KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_BASE_MACOS] = LAYOUT_all(
        ...
        KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,            KC_DEL,  KC_END,  KC_PGDN,
        KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT,   KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_ROPT,                     KC_UP,
        KC_LCTL,   XXXXXXX, KC_LCMD,                            KC_SPC,                             XXXXXXX, FNMACOS, XXXXXXX, KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN_LINUX] = LAYOUT_all(
        QK_BOOT,   XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRID, KC_BRIU, _______, _______, _______, KC_F13,              _______, _______, EE_CLR,
