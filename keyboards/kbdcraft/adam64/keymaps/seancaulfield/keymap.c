...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_64_ansi(
        ...
        _______, RGB_TOG,  RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_MOD, KC_PSCR,  KC_SCRL,  KC_PAUS,  KC_NO, 
        ...
        _______, _______,  _______,                   _______,                            _______, KC_TRNS,  RGB_MOD,  KC_VOLD,  RGB_TOG
    )
};
