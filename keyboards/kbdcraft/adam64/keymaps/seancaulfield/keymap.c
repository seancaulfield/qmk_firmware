...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_64_ansi(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,                   KC_SPC,                             KC_APP, MO(1),    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT_64_ansi(
        ...
        _______, _______,  _______, _______, _______, QK_BOOT, NK_TOGG, _______, _______, _______, _______, _______, KC_PGUP, _______,
