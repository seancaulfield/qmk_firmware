...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE_LINUX] = LAYOUT_all(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC, XXXXXXX, KC_PGUP,
        ...
        KC_LGUI, XXXXXXX, KC_LALT,          XXXXXXX,               KC_SPC,               XXXXXXX,          XXXXXXX, FNLINUX, KC_LEFT, KC_DOWN, KC_RIGHT),

    [_FN_LINUX] = LAYOUT_all(
        QK_BOOT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, EE_CLR,
        ...
        _______, RGB_RMD, RGB_VAD, RGB_HUD, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    [_BASE_MACOS] = LAYOUT_all(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, XXXXXXX, KC_ENT,           KC_PGDN,
        KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_END,
        KC_LOPT, XXXXXXX, KC_LCMD,          XXXXXXX,               KC_SPC,               XXXXXXX,          XXXXXXX, FNMACOS, KC_LEFT, KC_DOWN, KC_RIGHT),
