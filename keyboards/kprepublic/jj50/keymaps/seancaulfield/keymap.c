...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_SATD, RM_SATU, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, RM_TOGG, RM_HUED, RM_HUEU, RM_NEXT,
