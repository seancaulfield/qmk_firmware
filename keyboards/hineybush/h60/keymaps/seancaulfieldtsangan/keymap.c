...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
      ...
      KC_LSFT, _______,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FN),
      KC_LCTL, KC_LGUI,  KC_LALT,          _______,          KC_SPC,           _______,          _______, KC_RALT, KC_RGUI, KC_RCTL
    ),
